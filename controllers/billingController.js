...
export const createConsultationFeeBilling = async (req, res) => {
  try {
    ...
    // Get the current user (receptionist) who is creating the billing
    const generatedByUserId = req.user?._id || req.user?.id || null;
    console.log('👤 Consultation fee billing generated by user:', generatedByUserId);
    ...
    const consultationFee = {
      ...
      generatedBy: generatedByUserId, // Store receptionist user ID
      createdAt: new Date()
    };
...
export const createRegistrationFeeBilling = async (req, res) => {
  try {
    ...
    // Get the current user (receptionist) who is creating the billing
    const generatedByUserId = req.user?._id || req.user?.id || null;
    console.log('👤 Registration fee billing generated by user:', generatedByUserId);
...
export const createServiceChargesBilling = async (req, res) => {
  try {
    ...
    // Get the current user (receptionist) who is creating the billing
    const generatedByUserId = req.user?._id || req.user?.id || null;
    console.log('👤 Service charges billing generated by user:', generatedByUserId);
...
export const createComprehensiveInvoice = async (req, res) => {
  try {
    ...
    // Get the current user (receptionist) who is creating the invoice
    const generatedByUserId = req.user?._id || req.user?.id || null;
    console.log('👤 Invoice generated by user:', generatedByUserId);
